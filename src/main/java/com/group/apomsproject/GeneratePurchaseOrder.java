...
public class GeneratePurchaseOrder extends javax.swing.JFrame {
    ...
    // Create Order object (assuming fields: orderId, productName, quantity, supplier, date)
    Order order = new Order(keyword1, keyword2, keyword3, keyword4, keyword5);

    // Use FileOperations to write to CSV
